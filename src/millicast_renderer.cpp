...
#include "zmq.hpp"
#include "millicast_renderer.hpp"
...
MillicastRenderer::MillicastRenderer(const std::string &title) : videostream::VideoRenderer(title) {
    // title_ = title;
    // width_ = 0;
    // height_ = 0;
    // has_frame_ = false;
...
MillicastRenderer::~MillicastRenderer() {
}
...
// void MillicastRenderer::init(const std::string &config_file, int stream_id) {
//     try{
...
void MillicastRenderer::on_frame(const millicast::VideoFrame& frame) {
